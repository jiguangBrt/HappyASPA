...
# #处理listening发过来的笔记
# @forum_bp.route('/share_listening_notes', methods=['POST'])
# @login_required
# def share_listening_notes():
#     try:
#         data = request.get_json()
#         title = data.get('title', 'Listening Notes')
#         content = data.get('content', '')
#         exercise_id = data.get('exercise_id')
#         category = data.get('category', 'Listening Practice')
