...
def downgrade():
    op.drop_index(op.f('ix_user_schedule_items_scheduled_date'), table_name='user_schedule_items')
    op.drop_index('ix_user_schedule_items_user_id_scheduled_date', table_name='user_schedule_items')
