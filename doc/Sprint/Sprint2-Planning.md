...
## Sprint Goal: 
We focused on optimizing AI-human interaction modules, bridging forum authority with personal achievement systems, and systematically polishing the UI/UX across vocabulary and dashboard components to ensure a seamless academic learning experience.
...
| AI bot | As a user, I want an AI Assistant to guide me through page features and discuss academic knowledge, so that I can easily navigate the site and deepen my understanding of the subjects. | AI bot for the whole website | Yihan Wang |
| Personal Center | As a user, I hope to be able to see my gold coin count in my personal center and obtain gold coins by signing in every day. As a forum user, I hope to enter my standardized English exam scores in my personal profile. As a high-scoring user, I hope to have a distinctive visual identifier. | The establishment of the basic template for the personal center | Jiachi Zhu |
