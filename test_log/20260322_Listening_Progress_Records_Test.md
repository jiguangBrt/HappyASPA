...
**Scene 1: Video Display Function (Positive Test)** 
* **Test content:** Create different accounts to perform various listening exercises and check progress synchronization. 
...
**Scene 2: Fun Question Progress Records** 
* **Test content:** Choose to "Continue from last progress" and verify the persistence of previous answer results. 
